...
python main.py --modelbased_safety --modelfree_safety \
               --coef_safety_modelbased 0.8 --coef_safety_modelfree 0.2 \
               ...
               --wandb_postfix "" \
               --not_use_wandb \
               --tensorboard_descript "safety_mb=0.8, safety_mf=0.2, safety=3000, grad=600"
