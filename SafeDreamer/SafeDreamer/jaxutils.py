...
class Lagrange(nj.Module):
  def __init__(
      self, lagrange_multiplier_init=1e-6, penalty_multiplier_init=5e-9, cost_limit=25.0):
  ...
  def update(self, cost_ret):
    # cost_value: [horizon, batch, dim]
    ...
    self.penalty_multiplier.write(c)
    """
