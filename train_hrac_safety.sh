...
python main.py --world_model --validation_without_image --random_start_pose --eval_freq 30000 --safety_subgoals --train_safe_model --controller_safe_model --man_rew_scale 0.1 --goal_loss_coeff 20 --safety_loss_coef 800 --max_timesteps 1800000 --wandb_postfix ""
