...
python main.py --eval_freq 1000 --controller_safe_model --man_rew_scale 0.1 --goal_loss_coeff 20 --max_timesteps 900000 --wandb_postfix ", testing_safety_subgoal, safety_loss_coef=2000"
